...
import type { TestNotificationsService } from './test-notifications-minimal.service';
...
// NO GUARDS - This controller bypasses all authentication for testing
@Controller()
export class TestNotificationsController {
  ...
  // Analytics routes moved above to avoid :id route conflict
}