...
export default async () => {
  console.log('🚀 Starting Auth Service Integration Test Global Setup...');
  ...
  try {
    ...
    const requiredTables = ['users', 'organizations', 'roles', 'permissions', 'login_events'];
    ...
    throw new Error(
      `❌ Database setup failed: ${error.message}\\n` +
        ...
        '3. Ensure test database exists: soc_auth_test'
    );
  }
  ...
  console.log('🎉 Auth Service Integration Test Global Setup Complete');
};
