...
export const RateLimitPresets = {
  ...
  PASSWORD_RESET: {
    short: { ttl: 300, limit: 3 }, // 3 requests per 5 minutes
    medium: { ttl: 900, limit: 5 }, // 5 requests per 15 minutes
    long: { ttl: 3600, limit: 10 }, // 10 requests per hour
  },
